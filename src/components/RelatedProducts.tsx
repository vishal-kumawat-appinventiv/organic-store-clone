...
const RelatedProducts = ({
  ...
  const productsRelatedCategory = useSelector((state: RootState) =>
    productsSelectors?.selectRelatedProdsFirstThree(state, category)
  );
  return (
    <>
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {productsRelatedCategory.map((p: ProductType) => {
            return (
