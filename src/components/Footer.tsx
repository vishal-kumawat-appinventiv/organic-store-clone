  ...
  return (
    <>
      <div className="bg-black text-[#aeaeae]">
        <div className="mainGrid max-w-7xl mx-auto grid grid-cols-2 gap-4 py-20">
          <div className="logoCol">
            <img src={logoImg} alt="img" />
            <p className="mt-10 italic mr-24 font-bold">
          ...
          <div className="rightCol grid grid-cols-2 gap-3">
            <div>
              <div>
            ...
            <div>
              ...
              <div className="btns flex gap-3 w-full mt-4">
                {btnImgs.map((b, idx) => {
